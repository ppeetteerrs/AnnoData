...
export interface localizationPropsInput {
}

export interface localizationPropsState {
    taskRecord: TaskInterface;
}

export interface localizationPropsDispatch {
}
...
class localization extends TaskScreenInterface<Props<localizationPropsInput, localizationPropsState, localizationPropsDispatch>, localizationState> {
    ...
    constructor(props: Props<localizationPropsInput, localizationPropsState, localizationPropsDispatch>) {
        super(props);
        this.state = {
            ...this.state,
            imageIndex: 0,
    ...
    navComponent = () => {
        return (
            <NavBarContent>
                {this.props.state.taskRecord.title} (LOCALIZATION)
            </NavBarContent>
        );
    }
...
function mapDispatchToProps(dispatch): {
    dispatcher: localizationPropsDispatch
} {
    return {
        dispatcher: {
...
const LocalizationScreen = connect(mapStateToProps, mapDispatchToProps)(localization);
export { LocalizationScreen };